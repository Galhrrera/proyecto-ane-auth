...
def layout():
    ...
    initial_line_plot_radioaltimetros = update_radioaltimetros_with_slider_values(default_distancia_value, default_frecuencia_value, default_csv_radioaltimetros, default_csv_scenario)
    ...
    return html.Div([
        ...
        dcc.Dropdown(
            id='csv-dropdown-radioaltimetros',
            options=[{'label': file, 'value': file} for file in csv_files_radioaltimetros],
            value=default_csv_radioaltimetros  # Establecer el primer archivo como valor predeterminado
        ),

        # Gráfico de líneas para radioaltímetros
        dcc.Graph(id='line-plot-radioaltimetros', figure=initial_line_plot_radioaltimetros)
    ], className="escenarios-container container")
